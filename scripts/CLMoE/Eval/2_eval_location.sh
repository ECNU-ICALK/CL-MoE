...
RESULT_DIR="./results/VQACL/location"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.CLMoE.model_vqa_cc_instruction \
        ...
        --question-file /your/catalogue/CLMoE/CL4VQA/test/test_q_location.json \
...
python llava/eval/CLMoE/eval_vqav2.py \
    --annotation_file /your/catalogue/CLMoE/CL4VQA/test/test_q_location.json \
